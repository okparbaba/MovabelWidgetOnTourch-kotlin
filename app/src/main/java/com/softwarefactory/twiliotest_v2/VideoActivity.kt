package com.softwarefactory.twiliotest_v2
...
class VideoActivity : AppCompatActivity() {
     ...
     */
    private val TWILIO_ACCESS_TOKEN = "AC250e0d3671bb22895c5ef37ab8ee95c3"//BuildConfig.TWILIO_ACCESS_TOKEN
    private val ACCESS_TOKEN_SERVER = "eyJjdHkiOiJ0d2lsaW8tZnBhO3Y9MSIsInR5cCI6IkpXVCIsImFsZyI6IkhTMjU2In0..n__LF-9pRvOaYnhcdiYukB_A04S-3Y_J0ho1Vpbx6WA"//BuildConfig.TWILIO_ACCESS_TOKEN_SERVER

    /*
     * Access token used to connect. This field will be set either from the console generated token
     * or the request to the token server.
     */
    private  var accessToken: String = "eyJjdHkiOiJ0d2lsaW8tZnBhO3Y9MSIsInR5cCI6IkpXVCIsImFsZyI6IkhTMjU2In0..Xi-HrqnCnT_HFUSjF6vq3yGhp_SzquOz-0XKSB01lrM"
    ...
    private fun moveLocalVideoToThumbnailView() {
        ...
        if (thumbnailVideoView.visibility == View.GONE) {
            ...
            thumbnailVideoView.setOnTouchListener(onTouchListener())
    ...
    private fun onTouchListener(): View.OnTouchListener {
        mainLayout = findViewById(R.id.videoContainer)
